    ...
    return (
        <div className="flex flex-col h-full gap-3 font-mono">
            <div className="flex justify-between items-center px-1">
                <span className="text-[10px] text-gray-500 uppercase">Neural Intelligence Hub</span>
                <span className="text-[10px] text-dark-accent font-bold animate-pulse flex items-center gap-1">
            ...
            <div className="flex-1 bg-dark-bg/20 border border-dark-accent/20 rounded p-4 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className={`text-xs leading-relaxed transition-opacity duration-500 ${loading ? 'opacity-30' : 'opacity-100'} ${loading ? 'animate-pulse' : ''} text-gray-300`}>
                        {summary}
                    </div>

                    <div className="mt-auto pt-4 flex justify-between items-end border-t border-dark-border/30">
                        <div className="flex flex-col">
                            <span className="text-[8px] text-gray-500 uppercase">Verification Level</span>
                            <span className="text-[10px] text-green-500 flex items-center gap-1"><ShieldCheck size={10} /> HIGH CONFIDENCE</span>
                        </div>
                        <button 
                            onClick={generateSummary}
                            disabled={loading}
                            className="bg-dark-accent/10 hover:bg-dark-accent/20 border border-dark-accent/30 text-dark-accent px-2 py-1 rounded text-[10px] flex items-center gap-1 transition-all"
                        >
            ...
            <div className="px-1 text-[8px] text-gray-600 uppercase flex justify-between">
